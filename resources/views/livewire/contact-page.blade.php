 ...
 <!-- breadcrumb area start -->
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-10">
                        <div class="rs-breadcrumb-wrapper">
                            ...
                            <p class="rs-breadcrumb-desc">Contactez-nous pour plus d'informations</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- breadcrumb area end -->
 <!-- contact area start -->
        <div class="rs-contact-area rs-contact-five section-space-top pb-30">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="rs-contact-wrapper">
                            <div class="rs-contact-item">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="40" height="29" viewBox="0 0 40 29">
                                ...
                                <div class="rs-contact-content">
                                    <h5 class="rs-contact-title">Adresse Email </h5>
                            ...
                            <div class="rs-contact-item">
                                <div class="rs-contact-shape">
                                    <img src="{{asset('assets/images/shape/three-line-shape.webp')}}" alt="image">
                                </div>
                                <div class="rs-contact-icon">
                                    <span>
                              <svg xmlns="http://www.w3.org/2000/svg" width="35" height="34" viewBox="0 0 35 34">
                                ...
                                <div class="rs-contact-content">
                                    <h5 class="rs-contact-title">Téléphone</h5>
                                    <div class="rs-contact-links">
                            ...
                            <div class="rs-contact-item">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="36" viewBox="0 0 32 36">
                                ...
                                <div class="rs-contact-content">
                                    <h5 class="rs-contact-title">Adresse</h5>
                                    <div class="rs-contact-links">
                           ...
                           {{--  <div class="rs-contact-item">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="34" height="38" viewBox="0 0 34 38">
                                ...
                                <div class="rs-contact-content">
                                    ...
                                    <div class="rs-contact-links">
                                        <a href="{{route('admission')}}"><i class=""></i></a>
                        ...
                        <div class="rs-contact-wrapper">
                            <div class="rs-contact-form">
                                <div class="section-title-wrapper mb-30">
                                    <h3 class="rs-contact-form-title rs-split-text-enable split-in-left mb-10">
                                        <span class="split-text">Contactez-nous</span>
                                    </h3>
                                </div>
                                <form wire:submit.prevent='envoyer'>
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="rs-contact-input-box">
                                                <div class="rs-contact-input">
                                                    <input id="email" wire:model="email" type="email" placeholder="Email Address*">
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="rs-contact-input-box">
                                                <div class="rs-contact-input">
                                                    <textarea id="message" wire:model="message" placeholder="Message*"></textarea>
                                                </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="rs-contact-btn">
                                                <button type="submit" wire:loading.attr="disabled" class="rs-btn has-theme-yellow hover-white w-100">
            ...
            <span wire:loading wire:target="envoyer">Traitement en cours...</span>
                            ...
                            <div class="rs-map-one">
                                <div class="rs-google-map">
                                   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d281.57565507420844!2d15.257819979058826!3d-4.435399576779028!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1a6a3b000d9caacf%3A0xa5b9f38c8cd24f0a!2sUniversit%C3%A9%20Panafricaine%20du%20Congo!5e1!3m2!1sfr!2scd!4v1784116885809!5m2!1sfr!2scd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="strict-origin-when-cross-origin"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
